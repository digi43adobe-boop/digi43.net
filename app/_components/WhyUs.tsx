...
const ICONS = [
  ...
  "M14.7 6.3a4 4 0 0 1-5.4 5.4L3 18v3h3l6.3-6.3a4 4 0 0 1 5.4-5.4l-2.5 2.5 1.4 1.4 2.5-2.5z",
      ...
      <div className="container-page relative">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-5 lg:sticky lg:top-28">
            ...
            <p className="mt-5 text-lg text-faded-silver">{dict.subtitle}</p>
          ...
          <div className="lg:col-span-7 grid sm:grid-cols-2 gap-4">
            {dict.reasons.map((r, i) => (
              <div key={r.title} className="card-floating p-6">
