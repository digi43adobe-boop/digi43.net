...
export async function FeaturedNews({
  ...
  try {
    posts = (await getAllPosts()).slice(0, MAX_CARDS);
  } catch {
              ...
              {posts.map((post) => {
                ...
                return (
                  <Link
                    ...
                    className="card-floating group flex flex-col overflow-hidden no-underline snap-start shrink-0 basis-[85%] sm:basis-[55%] md:basis-[calc((100%-2rem)/3)] lg:basis-[calc((100%-2rem)/3)]"
                  >
